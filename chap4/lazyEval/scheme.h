...
public:
	...
	virtual bool isThunk() {
		return false;
	}
	virtual bool& isEvaled() {
		fck("type error");
		// never do this;
		bool a = false;
		return a;
	...
	virtual SchemeValuePtr value()  {
		fck("type should be thunk");
		return nullptr;
	}
	virtual SchemeValuePtr result() {
		fck("type should be thunk");
		return nullptr;
	}
	virtual EnvPtr env()  {
...
class Thunk : public SchemeValue {
public:
	Thunk(SchemeValuePtr v, EnvPtr e): evaled(false), result_(nullptr), value_(v), env_(e) {}
	void print(ostream& out) const override {
		out << "#thunk";
	}
	...
	bool& isEvaled() override {
		return evaled;
	}
	SchemeValuePtr value() override {
		return value_;
	}
	SchemeValuePtr result() override {
		return result_;
	}
	EnvPtr env() override {
		return env_;
	...
	bool evaled;
	SchemeValuePtr result_;
	SchemeValuePtr value_;
	EnvPtr env_;
};
